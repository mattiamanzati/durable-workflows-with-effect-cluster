import{d as _,a4 as d,a5 as p,a6 as m,b as u,a7 as h,o,e as n,f as t,t as a,g as r,F as f,h as g,n as v,a8 as x,a9 as y,k as b,l as k,m as N,_ as P}from"./index-BDIc6RmS.js";import{N as w}from"./NoteDisplay-CBcU-RRS.js";const V={class:"m-4"},D={class:"mb-10"},L={class:"text-4xl font-bold mt-2"},S={class:"opacity-50"},T={class:"text-lg"},z={class:"font-bold flex gap-2"},B={class:"opacity-50"},H=t("div",{class:"flex-auto"},null,-1),C={key:0,class:"border-gray-400/50 mb-8"},F=_({__name:"PresenterPrint",setup(M){d(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
